...
exports.run = async(client, message, args) => {
  ...
  if (!message.member.hasPermission("BAN_MEMBERS")) return message.reply("Bu komutu kullanabilmek için `Üyeleri Yasakla` yetkisine sahip olmanız gerek.");
  ...
  if(!kisi) return message.reply("Banlayacağım Kişiyi Belirtmen Gerekiyor `@kullanici / sebep`")
...
exports.help = {
  name: 'ban',
  description: 'Bir Oyuncuyu Yasaklar !',
  usage: 'ban'
};